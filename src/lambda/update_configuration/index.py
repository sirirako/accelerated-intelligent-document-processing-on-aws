    ...
    try:
        ...
        if request_type in ['Create', 'Update']:
            ...
            if 'Schema' in properties:
                ...
                manager.update_configuration('Schema', {'Schema': resolved_schema})
            ...
            if 'Default' in properties:
                ...
                manager.update_configuration('Default', resolved_default)
            ...
            if 'Custom' in properties and properties['Custom'].get('Info') != 'Custom inference settings':
                ...
                # ConfigurationManager handles migration automatically
                manager.update_configuration('Custom', resolved_custom)
