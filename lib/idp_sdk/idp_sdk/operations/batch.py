...
class BatchOperation:
    ...
    def get_status(
        self, batch_id: str, stack_name: Optional[str] = None
    ) -> BatchStatusResult:
        """Get batch status."""
        return self._client.get_status(batch_id=batch_id, stack_name=stack_name)

    def list(
        self, limit: int = 10, stack_name: Optional[str] = None
    ) -> List[BatchInfo]:
        """List recent batches."""
    ...
    def download(
        ...
        return self._client.download_results(
            batch_id=batch_id,
    ...
    def rerun(
        ...
        return self._client.rerun_inference(
            step=step,
