...
def _bundle_ui(request_type: str) -> str:
    ...
    # Source is the published artifact under FeatureKeyPrefix in the artifacts
    # bucket; destination is the host's canonical WebUIBucket layout that
    # FeatureLoader fetches.
