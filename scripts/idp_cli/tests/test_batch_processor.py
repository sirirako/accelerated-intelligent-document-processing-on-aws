...
class TestBatchProcessor:
    ...
    @patch('boto3.client')
    @patch('boto3.resource')
    def test_init_invalid_stack(self, mock_resource, mock_client, mock_stack_info_class):
    ...
    @patch('boto3.client')
    @patch('boto3.resource')
    def test_process_batch(self, mock_resource, mock_client, mock_parse_manifest, mock_stack_info_class):
    ...
    def test_upload_local_file(self, mock_resource, mock_client, mock_stack_info_class):
        ...
        assert 'doc1' in s3_key
    
    @patch('idp_cli.batch_processor.StackInfo')
    @patch('boto3.client')
    @patch('boto3.resource')
    def test_validate_s3_key_exists(self, mock_resource, mock_client, mock_stack_info_class):
    ...
    @patch('boto3.client')
    @patch('boto3.resource')
    def test_validate_s3_key_not_found(self, mock_resource, mock_client, mock_stack_info_class):
    ...
    def test_generate_batch_id(self, mock_resource, mock_client, mock_stack_info_class):
        ...
        assert len(batch_id1.split('-')) >= 4
    
    @patch('idp_cli.batch_processor.StackInfo')
    @patch('boto3.client')
    @patch('boto3.resource')
    def test_store_and_retrieve_batch_metadata(self, mock_resource, mock_client, mock_stack_info_class):
    ...
    @patch('boto3.client')
    @patch('boto3.resource')
    def test_get_batch_info_not_found(self, mock_resource, mock_client, mock_stack_info_class):
