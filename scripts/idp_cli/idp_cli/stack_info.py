...
class StackInfo:
    ...
    def get_resources(self) -> Dict[str, str]:
        ...
        resources['EvaluationBaselineBucket'] = outputs.get('S3EvaluationBaselineBucketName', '')
...
def get_stack_resources(stack_name: str, region: Optional[str] = None) -> Dict[str, str]:
    """
